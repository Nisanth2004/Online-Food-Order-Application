...
const PlaceOrder = () => {
  ...
  const initiateRazorpayPayment=async(order)=>{
    ...
    // create the object data to pass in razorpay payment gateway
    const options={
      key:RAZORPAY_KEY,
      amount:order.amount ,// convert to paise
      currency:"INR",
      name:"Food Land",
      description:"SN Food Order Payment",
      ...
      modal:{
        // if order failed or dialog box is closed , delete the order
 ...
 <div className="py-5 text-center">
  ...
  cartItems.map(item => (
    <li key={item.id} className="list-group-item d-flex justify-content-between lh-sm">
      ...
      <span className="text-body-secondary">&#8377;{item.price * (quantities[item.id] || 1)}</span>
    </li>
  ))
) : (
        ...
        <form className="needs-validation" onSubmit={onSubmitHandler}>
          <div className="row g-3">
            ...
            <div className="col-12">
              ...
              <input type="number" className="form-control" id="phone" name="phoneNumber" onChange={onChangeHandler} value={data.phoneNumber} placeholder="9159849275" required/>
            ...
            <div className="col-md-5">
              <label htmlFor="state" className="form-label"
               name="state" onChange={onChangeHandler} value={data.state}
              >State</label>
            ...
            <div className="col-md-3">
              <label htmlFor="zip" className="form-label"
               name="zip" onChange={onChangeHandler} value={data.zip}
              >Zip</label>
              <input type="number" className="form-control" id="zip" placeholder="641014" required/>
